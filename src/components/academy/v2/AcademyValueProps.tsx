            ...
            >
              <div className="aspect-[4/3] rounded-sm overflow-hidden shadow-2xl">
                <ImageWatermark className="relative w-full h-full rounded-sm overflow-hidden">
                  <img
                    {...imgProps("https://bgumoxbjyuzc6ytp.public.blob.vercel-storage.com/academy/academy_valuprop1.webp", "(min-width: 1024px) 42vw, 100vw")}
                    alt="Profi sminkek"
          ...
          <div className="flex flex-col lg:flex-row-reverse gap-12 lg:gap-24 items-center">
            ...
            >
              <div className="aspect-[4/3] rounded-sm overflow-hidden shadow-2xl">
                <ImageWatermark className="relative w-full h-full rounded-sm overflow-hidden">
                  <img
                    {...imgProps("https://bgumoxbjyuzc6ytp.public.blob.vercel-storage.com/academy/academy_valuprop2.webp", "(min-width: 1024px) 42vw, 100vw")}
          ...
          <div className="py-12 border-y border-charcoal-800/5">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {Array.from({ length: 8 }, (_, i) => i + 1).map((item) => (
                ...
                >
                  <img
                    {...imgProps(`https://bgumoxbjyuzc6ytp.public.blob.vercel-storage.com/academy/portfolio/${item}.webp`, "(min-width: 768px) 25vw, 50vw")}
                    alt={`Portfólió ${item}`}
