...
export default function GalleryCarousel({ images, label, title, subtitle }: GalleryCarouselProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="text-center space-y-3 px-6 mb-10 sm:mb-14">
            <span className="text-[11px] font-bold tracking-luxury text-gold-500 uppercase block">{label}</span>
